...
import 'package:social_git_app/modules/chat_screen/chat_screen.dart';
import 'package:social_git_app/modules/profile/profile.dart';
import 'package:social_git_app/modules/search_screen/search_screen.dart';
...
class SocialLayoutScreen extends StatefulWidget {
  ...
  const SocialLayoutScreen({Key? key, required this.afterLoginOrRegister})
      : super(key: key);

  @override
  _SocialLayoutScreenState createState() =>
      _SocialLayoutScreenState(afterLoginOrRegister);
}
