...
import 'package:social_git_app/shared/components/components.dart';
import 'package:social_git_app/shared/components/constants.dart';
import 'package:social_git_app/shared/social_cubit/social_cubit.dart';
import 'package:social_git_app/shared/social_cubit/social_states.dart';
            ...
            return Scaffold(
                ...
                body: cubit.personModel != null &&
                    ...
                    ? SmartRefresher(
                        ...
                        onRefresh: () async {
                          cubit.getAnotherPersonData(personUid: personUid);
                                        ...
                                        child: GridView.count(
                                          ...
                                          children: List.generate(
                                              ...
                                              (index) => singlePhotoBuilder(
                                                  cubit.personImages[index],
                                                  cubit.personTexts[index])),
                                        ),
                                      ),
                                    ],
                                  ),
  ...
  Widget followersBuilder() {
    return ListView.separated(
        ...
        itemBuilder: (context, index) => singleUserBuilder(
            SocialCubit.get(context).personUsers[index], context),
        separatorBuilder: (context, index) => SizedBox(
              height: 10,
            ),
