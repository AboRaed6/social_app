...
import 'package:social_git_app/models/post_model.dart';
import 'package:social_git_app/models/recent_messages_model.dart';
import 'package:social_git_app/models/user_model.dart';
import 'package:social_git_app/modules/chat_screen/person_chat_screen/person_chat_screen.dart';
import 'package:social_git_app/modules/comments_screen/comments_screen.dart';
import 'package:social_git_app/modules/image_view_screen/image_view_screen.dart';
import 'package:social_git_app/modules/login_screen/login_screen.dart';
import 'package:social_git_app/modules/person_profile/person_profile.dart';
import 'package:social_git_app/modules/profile/profile.dart';
import 'package:social_git_app/shared/network/local/cache_helper.dart';
import 'package:social_git_app/shared/social_cubit/social_cubit.dart';
import 'package:social_git_app/shared/style/icon_broken.dart';
...
Widget singleMyPostBuilder(PostModel post, context, index) {
  return Dismissible(
    ...
    onDismissed: (direction) {
      SocialCubit.get(context)
          .deletePost(SocialCubit.get(context).myPostsId[index]);
    },
    child: Card(
      clipBehavior: Clip.antiAlias,
      margin: EdgeInsets.only(left: 5, right: 5),
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        if (SocialCubit.get(context).myLikedByMe[index] ==
                            true) {
                          SocialCubit.get(context).disLikePost(
                              SocialCubit.get(context).myPostsId[index]);
                      ...
                      onTap: () {
                        navigateTo(
                            ...
                            CommentsScreen(
                                ...
                                SocialCubit.get(context).personModel!.uid));
                      },
                      child: Text('Comments')),
                ],
              ),
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                    onPressed: () {
                      if (SocialCubit.get(context).personIsLikedByMe[index] ==
                          true) {
                        SocialCubit.get(context).disLikePost(
                            SocialCubit.get(context).personPostsId[index]);
                        SocialCubit.get(context).personIsLikedByMe[index] =
                            false;
    ...
    child: InkWell(
      onTap: () {
        FirebaseFirestore.instance
            ...
            .get()
            .then((value) {
          SocialCubit.get(context).userForRecentMessage =
              UserModel.fromJson(value.data());
        }).then((value) {
          navigateTo(context,
              PersonChatScreen(SocialCubit.get(context).userForRecentMessage));
        });
      },
      child: Padding(
        padding: const EdgeInsets.only(top: 12, left: 12, right: 12),
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 14,
                              color:
                                  r.receiverId == uid ? GREEN : Colors.black54,
                              fontWeight: FontWeight.w500),
                        ),
                      ),
                      SizedBox(
